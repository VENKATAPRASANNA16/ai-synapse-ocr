...
class TableDetectionService:
    ...
    def _organize_cells(self, cells: List[Dict], table_img: np.ndarray) -> List[List[str]]:
        ...
        y_threshold = 20  # Tolerance for row grouping
    ...
    def _calculate_table_confidence(
        ...
        # 1. Cell count score
        cell_score = min(len(cells) / 50.0, 1.0)
